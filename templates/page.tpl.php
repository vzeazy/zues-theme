    ...
    <header id="header" class="clearfix">
      ...
      <ul id="header-social" class="clearfix">
        <?php if ($facebook_url): ?><li>
          <a class="fa fa-facebook" target="_blank" title="<?php print $site_name; ?> in Facebook" href="<?php print $facebook_url; ?>"> </a>
        </li><?php endif; ?>
        <?php if ($twitter_url): ?><li>
          <a class="fa fa-twitter" target="_blank" title="<?php print $site_name; ?> in Twitter" href="<?php print $twitter_url; ?>"></a>
        </li><?php endif; ?>
        <?php if ($google_plus_url): ?><li>
          <a class="fa fa-google-plus" target="_blank" title="<?php print $site_name; ?> in Google+" href="<?php print $google_plus_url; ?>">  </a>
        </li><?php endif; ?>
        <?php if ($pinterest_url): ?><li>
          <a class="fa fa-pinterest" target="_blank" title="<?php print $site_name; ?> in Pinterest" href="<?php print $pinterest_url; ?>"> </a>
        </li><?php endif; ?>
        <li>
          <a class="fa fa-rss" target="_blank" title="<?php print $site_name; ?> in RSS" href="<?php print $front_page; ?>rss.xml"> </a>
        </li>
      </ul>
    </header>
  </div>
